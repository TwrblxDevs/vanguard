...
All client-to-server traffic passes through the configured [Network Security](../network-security/README.md) pipeline before service code receives it.
...
Continue with [Network Security](../network-security/README.md) and [Validator](../utilities/validator/README.md).
