...
1. read the complete first error, not only the final “requested module experienced an error” line;
...
Prefer direct require paths. If using `WaitForChild`, add the static type cast shown in [Getting Started](../getting-started/README.md).
