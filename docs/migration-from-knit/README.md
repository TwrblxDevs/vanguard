...
Audit method names and behavior against [Networking](../networking/README.md). Remote properties are server-owned and support global/per-player values.
...
For specific service/controller fields, intersect custom shapes with base types. See [Type System](../type-system/README.md).
