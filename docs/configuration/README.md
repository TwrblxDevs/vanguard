...
Numeric levels are also accepted. See [Logger](../utilities/logger/README.md) for exact behavior.
...
Read [Network Security](../network-security/README.md) before configuring these callbacks.
...
See [Lifecycle](../lifecycle/README.md) for startup timing.
