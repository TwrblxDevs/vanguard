...
Do not trust client arguments. Apply [Network Security](../network-security/README.md) rules and re-check authoritative state in server methods.
...
See [Networking](../networking/README.md) for every method.
...
Read [Lifecycle](../lifecycle/README.md) for the exact guarantees.
